  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        time: '下午—傍晚',
        desc: '入住 · 中街 · 晚餐',
        body: '入住中街、故宫或青年大街北段附近酒店，酒店休息后傍晚逛中街。晚餐品尝老边饺子、沈阳鸡架或东北菜。\n\n这一天不安排正式景点，给孩子恢复体力。',
      },
      {
        id: 'd6-3',
        time: '晚上（可选）',
        desc: '老北市看夜景',
        body: '如果抵达较早、孩子状态好，可晚上前往老北市；如果已经疲劳，就把老北市留到 D8。老北市晚上比白天更有氛围：看老建筑和民俗街区、吃小吃、看非遗或街头表演，控制在 2 小时以内。',
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        detailsList: [
          ...
          { label: '讲解', value: '建议使用人工讲解或儿童版语音讲解，孩子更容易理解' },
          { label: '引导', value: '① 沈阳故宫为什么比北京故宫小？② 努尔哈赤和皇太极曾在哪里生活？③ 哪些建筑具有明显的东北和满族特点？' },
        ],
        badges: [
          { text: '分时段预约', type: 'red' },
          { text: '凭原件入馆' },
      ...
      },
      {
        ...
        time: '11:30—13:30',
        desc: '午餐＋休息',
        body: '故宫和张学良旧居距离不远，但不要立刻连续参观。先找餐厅吃饭，休息约 30 分钟。',
      },
      {
        id: 'd7-3',
        time: '14:00—16:30',
        ...
        detailsList: [
          ...
          { label: '重点', value: '大青楼、小青楼、中式与西式建筑的差别、张学良及近代沈阳的历史' },
          { label: '亲子', value: '7 岁 9 岁不必听太复杂的政治历史，重点放在人物故事和建筑观察上' },
        ],
        badges: [
      ...
      },
      {
        id: 'd7-4',
        time: '16:30以后',
        desc: '体力判断：金融博物馆 / 回酒店 / 中街散步',
        body: '状态好 → 继续参观金融博物馆。\n已经疲劳 → 回酒店休息。\n晚上 → 中街吃饭、简单散步。\n\n这一天不要再加"九一八"历史博物馆，连续参观多个历史场馆，孩子容易信息过载。',
      },
    ],
  },
  {
    ...
    entries: [
      {
        id: 'd8-1',
        time: '09:00—12:00',
        desc: '中国工业博物馆（约2.5-3h）',
        isSight: true,
        detailsList: [
          { label: '概述', value: '沈阳最能体现工业城市特色的博物馆，大型机床、铸造设备、工厂生产场景复原' },
          { label: '亲子任务', value: '① 找到全馆最大的一台机器 ② 找一个自己最喜欢的工业产品 ③ 猜一猜不同机器是做什么的 ④ 回酒店后说出一个印象最深的展品' },
          { label: '策略', value: '比单纯走展厅更有参与感，孩子 7 岁 9 岁正对大型机械充满好奇' },
        ],
        badges: [
          { text: '沈阳特色', type: 'gold' },
          { text: '亲子友好', type: 'green' },
        ],
      },
      {
        id: 'd8-2',
        time: '12:00—13:30',
        desc: '铁西区午餐',
        body: '在铁西区吃饭，避免立刻返回中街，下午安排低强度活动。',
      },
      {
        id: 'd8-3',
        time: '14:00—15:30',
        desc: '红梅文创园（可选）',
        body: '由老工业建筑改造而成，与上午的工业博物馆主题自然衔接。适合看旧厂房改造、拍照、喝饮料休息，感受沈阳从工业城市到现代城市的变化。\n\n不是必须打卡的大型景点，如果当天炎热、下雨或孩子累，可以直接取消回酒店午休。',
      },
      {
        id: 'd8-4',
        time: '16:00—18:00',
        desc: '酒店休息',
        body: 'D8 已经是旅行后半段，建议安排一次完整休息。',
      },
      {
        id: 'd8-5',
        time: '18:30—20:30',
        desc: '老北市夜游',
        body: '看老建筑和民俗街区、吃小吃、看非遗或街头表演、购买少量当地特产。控制在 2 小时以内，不必逛到很晚。\n\n如果 D6 已经去过老北市，今晚可以在中街轻松逛街。',
      },
      {
        id: 'd8-6',
        time: '⚠️ 备用方案',
        desc: '下雨 / 高温 / 闭馆应对',
        body: '【D7 下雨】沈阳故宫部分户外院落受影响 → 上午张学良旧居，下午金融博物馆，沈阳故宫移到 D8 上午。\n\n【D8 高温或下雨】工业博物馆正常保留，红梅文创园取消，下午改为酒店休息、商场活动或只选辽宁省博物馆重点展厅。\n\n【工业博物馆闭馆】如果 D8 恰逢闭馆日，可在 D7/D8 之间对调，或替换为沈飞航空博览园（两个孩子喜欢飞机、机械或模型时尤其合适）。',
      },
    ],
  },
  {
...
const RESERVATIONS: ReservData[] = [
  ...
  { name: '中国工业博物馆', channel: '官方平台预约', advance: '建议提前', price: '以官方为准' },
  { name: '张学良旧居', channel: '沈阳市文旅局平台', advance: '建议提前', price: '以官方为准' },
  { name: '沈飞航空博览园（备选）', channel: '官方平台', advance: '—', price: '以官方为准' },
]
  ...
  return (
    ...
    <div className={`${styles.page} ${visible ? styles.visible : ''}`}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.heroSub}>暑期亲子 · 2026.8.14 — 8.23 · 南京出发 ✦ 清凉东北</p>
        <div className={styles.heroStats}>
          ...
          <div className={styles.heroStat}>
            <span className={styles.heroStatN}>6</span>
        ...
        <div className={styles.routeMap}>
          <div className={styles.routeRow}>
            <span className={styles.routeStop}>
              ...
              <span className={styles.routeStopDate}>8/14</span>
            </span>
            <span className={styles.routeDash} />
            <span className={styles.routeStop}>
              <span className={styles.routeStopDot} />
              <span className={styles.routeStopName}>哈尔滨</span>
              <span className={styles.routeStopDate}>8/15-17</span>
            </span>
            <span className={styles.routeDash} />
            <span className={styles.routeStop}>
              <span className={styles.routeStopDot} />
              <span className={styles.routeStopName}>长白山</span>
              <span className={styles.routeStopDate}>8/17-20</span>
            </span>
            <span className={styles.routeDash} />
            <span className={styles.routeStop}>
              <span className={styles.routeStopDot} />
              <span className={styles.routeStopName}>沈阳</span>
              <span className={styles.routeStopDate}>8/20-23</span>
            </span>
          </div>
          ...
          <div className={`${styles.routeRow} ${styles.routeRowReverse}`}>
            <span className={styles.routeStop}>
              <span className={styles.routeStopDot} />
              <span className={styles.routeStopName}>南京</span>
              <span className={styles.routeStopDate}>8/23</span>
            </span>
            <span className={styles.routeDash} />
            <span className={styles.routeStop}>
              <span className={styles.routeStopDot} />

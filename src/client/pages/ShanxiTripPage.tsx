...
const RESERVATIONS = [
  { name: '云冈石窟', channel: '官方公众号', advance: '15天', price: '(下午16:30放票)成人120元·儿童半价' },
  { name: '悬空寺', channel: '官方平台', advance: '7天', price: '(上午7:20放票)首道15元·登临100元' },
  ...
  { name: '山西博物院', channel: '官方公众号', advance: '3天', price: '(上午7:00放票)免费' },
  { name: '大同市博物馆', channel: '官方公众号', advance: '7天', price: '(中午12:00放票)免费' },
]
